...
void ExampleManager::on_update_blank_content()
{
	...
	ImGui::TextDisabled(u8"@ Chr11111s"); ImGui::SameLine();
	if (ImGui::ImageButton(ResourcesManager::instance()->find_texture("icon-bilibili"), { 14, 14 }))
		ShellExecute(NULL, TEXT("open"), TEXT("https://github.com/Chr11111s"), NULL, NULL, SW_SHOWNORMAL);
	if (ImGui::IsItemHovered())
	{
		ImGui::BeginTooltip();
		ImGui::TextDisabled(u8"点击打开我的 Github 主页 ~");
		ImGui::EndTooltip();
	}
}
